 ...
 */
type JQueryPromiseCallback<T> = (value?: T, ...args: any[]) => void;

type JQueryPromiseOperator<T, U> = (callback1: JQueryPromiseCallback<T>|Array<JQueryPromiseCallback<T>>, ...callbacksN: Array<JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>>) => JQueryPromise<U>;
...
interface JQueryPromise<T> extends JQueryGenericPromise<T> {
     ...
     */
	always(alwaysCallback1?: JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>, ...alwaysCallbackN: Array<JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>>): JQueryPromise<T>;
	/**
     ...
     */
	done(doneCallback1?: JQueryPromiseCallback<T>|Array<JQueryPromiseCallback<T>>, ...doneCallbackN: Array<JQueryPromiseCallback<T>|Array<JQueryPromiseCallback<T>>>): JQueryPromise<T>;
	/**
     ...
     */
	fail(failCallback1?: JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>, ...failCallbackN: Array<JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>>): JQueryPromise<T>;
	/**
     ...
     */
	progress(progressCallback1?: JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>, ...progressCallbackN: Array<JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>>): JQueryPromise<T>;
...
interface JQueryDeferred<T> extends JQueryGenericPromise<T> {
     ...
     * @see {@link https://api.jquery.com/deferred.always/}
     */
	always(alwaysCallback1?: JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>, ...alwaysCallbackN: Array<JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>>): JQueryDeferred<T>;
	/**
     * Add handlers to be called when the Deferred object is resolved.
     *
     * @param doneCallback1 A function, or array of functions, that are called when the Deferred is resolved.
     ...
     * @see {@link https://api.jquery.com/deferred.done/}
     */
	done(doneCallback1?: JQueryPromiseCallback<T>|Array<JQueryPromiseCallback<T>>, ...doneCallbackN: Array<JQueryPromiseCallback<T>|Array<JQueryPromiseCallback<T>>>): JQueryDeferred<T>;
	/**
     * Add handlers to be called when the Deferred object is rejected.
     *
     * @param failCallback1 A function, or array of functions, that are called when the Deferred is rejected.
     ...
     * @see {@link https://api.jquery.com/deferred.fail/}
     */
	fail(failCallback1?: JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>, ...failCallbackN: Array<JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>>): JQueryDeferred<T>;
	/**
     * Add handlers to be called when the Deferred object generates progress notifications.
     *
     * @param progressCallback1 A function, or array of functions, to be called when the Deferred generates progress notifications.
     ...
     * @see {@link https://api.jquery.com/deferred.progress/}
     */
	progress(progressCallback1?: JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>, ...progressCallbackN: Array<JQueryPromiseCallback<any>|Array<JQueryPromiseCallback<any>>>): JQueryDeferred<T>;
...
interface JQueryStatic {
     ...
     */
	contains(container: Element | Document, contained: Element): boolean;
	...
	mustache(template: string, view: object, partials?: object): string;
...
interface JQuery {
	...
	datepicker(data : any): JQuery;
	draggable(data : any): JQuery;
	maxZIndex() : void;
	chosen(data: any) : void;
	minicolors(command?: string | any) : JQuery;
	show_sys_message(text: string, type: string) : void;
